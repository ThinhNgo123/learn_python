...
class FrameMenuInternetWifi:
    ...
    def __init__(self, hmi_screen):
        ...
        self.field.set_title(center_x=FrameMenuInternetWifi.TITLE_CENTER_X, center_y=FrameMenuInternetWifi.TITLE_CENTER_Y)
        self.field.set_first_element_position(FrameMenuInternetWifi.FIRST_FIELD_POS_X, FrameMenuInternetWifi.FIRST_FIELD_POS_Y)
        self.edit = MenuEdit(self)
        self.edit.set_first_element_position(FrameMenuInternetWifi.FIRST_EDIT_POS_X, FrameMenuInternetWifi.FIRST_EDIT_POS_Y)
    ...
    def event_handling(self, event):
        if event == FrameMenuInternetWifi.ACTION_HELP:
            ...
            if event == FrameMenuInternetWifi.ACTION_DELETE:
...
def main():
    test = FrameMenuInternetWifi("hmi")
    test.draw()
    test.get_image().show()
