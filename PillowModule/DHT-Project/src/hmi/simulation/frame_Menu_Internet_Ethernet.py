...
class FrameMenuInternetEthernet:
    ACTION_UP = "up"
    ACTION_DOWN = "down"
    ACTION_BACK = "left"
    ACTION_OK = "enter"
    ...
    def __init__(self, hmi_screen):
        ...
        self.field.set_title(center_x=FrameMenuInternetEthernet.TITLE_CENTER_X, center_y=FrameMenuInternetEthernet.TITLE_CENTER_Y)
        self.field.set_first_element_position(FrameMenuInternetEthernet.FIRST_FIELD_POS_X, FrameMenuInternetEthernet.FIRST_FIELD_POS_Y)
        self.edit = MenuEdit(self)
        self.edit.set_first_element_position(FrameMenuInternetEthernet.FIRST_EDIT_POS_X, FrameMenuInternetEthernet.FIRST_EDIT_POS_Y)
    ...
    def event_handling(self, event):
        if event == FrameMenuInternetEthernet.ACTION_HELP:
            ...
            if event == FrameMenuInternetEthernet.ACTION_DELETE:
...
def main():
    test = FrameMenuInternetEthernet("hmi")
    test.draw()
    test.get_image().show()
