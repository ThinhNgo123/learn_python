...
class FrameMenuUser:
    ...
    def __init__(self, hmi_screen):
        ...
        self.field.set_title(title="User" ,center_x=FrameMenuUser.TITLE_CENTER_X, center_y=FrameMenuUser.TITLE_CENTER_Y)
        self.field.set_first_element_position(FrameMenuUser.FIRST_FIELD_POS_X, FrameMenuUser.FIRST_FIELD_POS_Y)
        self.edit = MenuEdit(self)
        self.edit.set_first_element_position(FrameMenuUser.FIRST_EDIT_POS_X, FrameMenuUser.FIRST_EDIT_POS_Y)
    ...
    def event_handling(self, event):
        if event == FrameMenuUser.ACTION_HELP:
            ...
            if event == FrameMenuUser.ACTION_DELETE:
