...
class Convent_Engine_Class:
    ...
    def convert_to_real64(self, registers):
        numb_str =  f"{registers[0]:04x}" +\
                        f"{registers[1]:04x}" +\
                        f"{registers[2]:04x}" +\
                        f"{registers[3]:04x}" 
        # print("numb_str",numb_str)
        # print("registers[0]",f"{registers[0]:04x}")
        # print("registers[1]",f"{registers[1]:04x}")
        # print("registers[2]",f"{registers[2]:04x}")
        # print("registers[3]",f"{registers[3]:04x}")
        return  struct.unpack('!d', bytes.fromhex(numb_str))[0]
