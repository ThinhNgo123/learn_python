...
atFTP_2_Server = atFTP_Server_Class(
    FTP_Server_Name = "FTP2")
atFTP_3_Server = atFTP_Server_Class(
    FTP_Server_Name = "FTP3")
atFTP_4_Server = atFTP_Server_Class(
    FTP_Server_Name = "FTP4")
atFTP_5_Server = atFTP_Server_Class(
    FTP_Server_Name = "FTP5")
