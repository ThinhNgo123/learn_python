...
# from atScreen_Monitoring import atScreen_Monitoring as Backward_Screen_Of_Database

class atFrame_Database(atFrame_Menu):
    def __init__(self,) -> None:
        ...
        super().__init__(
            name = name,
            list= [
                atData.screen_names["Setting"]["Database"]["List"]["screen name"],
                atData.screen_names["Setting"]["Database"]["Store_Time"]["screen name"],
            ]
        )
...
atScreen_Database = atFrame_Database()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Database.name)
    while 1:
