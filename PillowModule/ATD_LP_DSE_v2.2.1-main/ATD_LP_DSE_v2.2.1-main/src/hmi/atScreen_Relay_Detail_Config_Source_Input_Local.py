...
class atFrame_Relay_Detail_Config_Source_Input_Local(atFrame_Menu):
    ...
    def load(self):
        if self.name == Current_Screen.name:
            if self.rended == False:
                ...
                self.set_menu(
                    list=[
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Local"]["Mode"]["screen name"],
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Local"]["Manual"]["screen name"],
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Local"]["Timers"]["screen name"],
                    ]
                )
...
atScreen_Relay_Detail_Config_Source_Input_Local = atFrame_Relay_Detail_Config_Source_Input_Local()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Relay_Detail_Config_Source_Input_Local.name)
    while 1:
