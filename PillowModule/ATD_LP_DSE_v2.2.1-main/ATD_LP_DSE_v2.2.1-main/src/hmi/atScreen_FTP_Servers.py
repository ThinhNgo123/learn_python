...
# from atScreen_Monitoring import atScreen_Monitoring as Backward_Screen_Of_FTP_Servers

class atFrame_FTP_Servers(atFrame_Menu):
    def __init__(self,) -> None:
        ...
        super().__init__(
            name = name,
            list= [
                atData.screen_names["Setting"]["FTP_Servers"]["FTP1"]["screen name"]
            ]
        )
...
atScreen_FTP_Servers = atFrame_FTP_Servers()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_FTP_Servers.name)
    while 1:
