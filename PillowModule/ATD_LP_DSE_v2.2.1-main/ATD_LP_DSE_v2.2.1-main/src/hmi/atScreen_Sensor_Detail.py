...
class atFrame_Sensor_Detail(atFrame_Menu):
    ...
    def load(self):
        if self.name == Current_Screen.name:
            if self.rended == False:
                ...
                self.set_menu(
                    list= [
                    atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Data"]["screen name"],
                    atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["screen name"],
                    atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Delete"]["screen name"],
                    atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Clone"]["screen name"]
                ]
                )
...
atScreen_Sensor_Detail = atFrame_Sensor_Detail()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Sensor_Detail.name)
    while 1:
