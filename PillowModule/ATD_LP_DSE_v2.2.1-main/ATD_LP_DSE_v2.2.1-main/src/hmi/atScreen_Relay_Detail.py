...
class atFrame_Relay_Detail(atFrame_Menu):
    def __init__(self,) -> None:
        ...
        super().__init__(
            name = name,
            list= [
                atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Data"]["screen name"],
                atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["screen name"],
                atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Delete"]["screen name"],
                atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Clone"]["screen name"]
            ]
        )
...
atScreen_Relay_Detail = atFrame_Relay_Detail()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Relay_Detail.name)
    while 1:
