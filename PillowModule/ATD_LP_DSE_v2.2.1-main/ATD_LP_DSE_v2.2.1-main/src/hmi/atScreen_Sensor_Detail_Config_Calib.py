...
class atFrame_Sensor_Detail_Config_Calib(atFrame_Menu):
    def __init__(self,) -> None:
        ...
        super().__init__(
            name = name,
            list=[
                atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Calib"]["Function"]["screen name"],
                atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Calib"]["Index"]["screen name"],
            ]
        )
...
atScreen_Sensor_Detail_Config_Calib = atFrame_Sensor_Detail_Config_Calib()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Sensor_Detail_Config_Calib.name)
    while 1:
