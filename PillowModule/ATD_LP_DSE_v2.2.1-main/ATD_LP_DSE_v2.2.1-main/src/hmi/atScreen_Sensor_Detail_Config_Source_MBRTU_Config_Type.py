...
class atFrame_Sensor_Detail_Config_Source_MBRTU_Config_Type(atFrame_Menu):
    def __init__(self,) -> None:
        super().__init__(
            name = atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Source"]["Modbus_RTU"]["Config"]["Type"]["screen name"],
            list=[
                "discrete",
                "input",
                "coil",
    ...
    def new_OK_callback(self):
        ...
        atData.data["Sensors"]["List"][self.Setting_Sensor_ID]["Source"]["Modbus RTU config"]["Type"] = self.get_chosen_submenu()
        atData.save("Sensors")
        notification = "Sensor:" + \
...
atScreen_Sensor_Detail_Config_Source_MBRTU_Config_Type = atFrame_Sensor_Detail_Config_Source_MBRTU_Config_Type()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Sensor_Detail_Config_Source_MBRTU_Config_Type.name)
    while 1:
