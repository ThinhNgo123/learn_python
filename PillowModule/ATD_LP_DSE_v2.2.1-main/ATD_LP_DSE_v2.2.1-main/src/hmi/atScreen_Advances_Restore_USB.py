...
class atFrame_Advances_Restore_USB(atFrame_Menu):
    def __init__(self,) -> None:
        ...
        super().__init__(
            name = name,
            list=[
                atData.screen_names["Setting"]["Advances"]["Restore_USB"]["Setting"]["screen name"],
                atData.screen_names["Setting"]["Advances"]["Restore_USB"]["Database"]["screen name"]                
            ]
        )
...
atScreen_Advances_Restore_USB = atFrame_Advances_Restore_USB()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Advances_Restore_USB.name)
    while 1:
