...
class atFrame_Sensor_Detail_Config_Source_MBRTU(atFrame_Menu):
    def __init__(self,) -> None:

        super().__init__(
            name = atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Source"]["Modbus_RTU"]["screen name"],
            list=[
                atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Source"]["Modbus_RTU"]["Select"]["screen name"],
                atData.screen_names["Setting"]["Sensors"]["Sensor_Detail"]["Config"]["Source"]["Modbus_RTU"]["Config"]["screen name"],
            ]
        )
...
atScreen_Sensor_Detail_Config_Source_MBRTU = atFrame_Sensor_Detail_Config_Source_MBRTU()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Sensor_Detail_Config_Source_MBRTU.name)
    while 1:
