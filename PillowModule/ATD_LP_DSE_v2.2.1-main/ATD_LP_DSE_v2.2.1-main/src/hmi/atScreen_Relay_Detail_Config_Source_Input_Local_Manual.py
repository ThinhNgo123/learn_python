...
class atFrame_Relay_Detail_Config_Source_Input_Local_Manual(atFrame_Menu):
    def __init__(self,) -> None:

        name= atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Local"]["Manual"]["screen name"]
    ...
    def save(self):
        ...
        atData.data["Relays"]["List"][self.Setting_Relay_ID]["Source"]["Input"]["Local"]["Manual"] = self.get_chosen_submenu()
        atData.save("Relays")
        sleep(0.5)
...
atScreen_Relay_Detail_Config_Source_Input_Local_Manual = atFrame_Relay_Detail_Config_Source_Input_Local_Manual()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Relay_Detail_Config_Source_Input_Local_Manual.name)
    while 1:
