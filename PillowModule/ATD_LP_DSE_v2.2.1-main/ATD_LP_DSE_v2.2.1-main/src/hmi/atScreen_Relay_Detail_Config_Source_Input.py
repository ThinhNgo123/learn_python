...
class atFrame_Relay_Detail_Config_Source_Input(atFrame_Menu):
    ...
    def load(self):
        if self.name == Current_Screen.name:
            if self.rended == False:
                ...
                self.set_menu(
                    list=[
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Protocol"]["screen name"],
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["MQTT"]["screen name"],
                        atData.screen_names["Setting"]["Relays"]["Relay_Detail"]["Config"]["Source"]["Input"]["Local"]["screen name"],
                    ]
                )
...
atScreen_Relay_Detail_Config_Source_Input = atFrame_Relay_Detail_Config_Source_Input()

if __name__ == "__main__":
    Current_Screen.set_name(atScreen_Relay_Detail_Config_Source_Input.name)
    while 1:
